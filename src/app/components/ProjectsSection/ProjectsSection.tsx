...
const projectsData = [
  ...
  },
  {
    ...
    description:
      "A simple quote generator project. Generates random quotes fetched from an API",
    image: "/images/projects/02_web_quotes_generator.png",
    previewUrl:
      "https://ztm-quotes-generator-portfolio-01-7rmb56jxs-samiurias.vercel.app",
...
export const ProjectsSection = () => {
  ...
  const differentTags: string[] = Array.from(
    new Set(projectsData.flatMap((project) => project.tag)),
  ).sort();
